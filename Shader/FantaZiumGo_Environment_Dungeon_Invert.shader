...
void main()
{
    ...
    u_xlat10_0 = texture2D(_BackgroundTexture, u_xlat16_0.xy);
...
{
    u_xlat16_0.xy = vs_TEXCOORD0.xy / vs_TEXCOORD0.ww;
    u_xlat16_0 = texture(_BackgroundTexture, u_xlat16_0.xy);
    SV_Target0.xyz = (-u_xlat16_0.xyz) + vec3(1.39999998, 1.0, 0.800000012);
