...
void main()
{
    ...
    u_xlat10_6.xy = texture2D(_WigTex, u_xlat6.xy).xy;
    ...
    u_xlat1 = u_xlat10_1 * _WaveCol;
    u_xlat0.xy = _Time.xy * vec2(vec2(_Freq, _Freq));
    u_xlat0.xy = sin(u_xlat0.xy);
    u_xlat0.xy = u_xlat0.xy * vec2(200.0, 200.0) + u_xlat6.xy;
    u_xlat0.xy = u_xlat0.xy / vec2(_TexScale);
    u_xlat10_0 = texture2D(_MainTex, u_xlat0.xy);
    u_xlat0 = u_xlat10_0 * _WaveCol;
    u_xlat0 = u_xlat0 * vec4(vec4(_WaveDecay, _WaveDecay, _WaveDecay, _WaveDecay)) + _MainCol;
    u_xlat0 = u_xlat1 * vec4(vec4(_WaveDecay, _WaveDecay, _WaveDecay, _WaveDecay)) + u_xlat0;
    ...
    u_xlat2 = (-_MainCol) + _FresCol;
    u_xlat1 = u_xlat1.xxxx * u_xlat2 + _MainCol;
...
uniform 	float _Amp;
uniform 	float _FresnelPower;
UNITY_LOCATION(0) uniform mediump sampler2D _WigTex;
...
void main()
{
    ...
    u_xlat0.xy = sin(u_xlat0.xy);
    u_xlat6.xy = vs_TEXCOORD0.xy / vec2(_TexScale);
    u_xlat16_6.xy = texture(_WigTex, u_xlat6.xy).xy;
    u_xlat1.xy = u_xlat16_6.xy * vec2(vec2(_Amp, _Amp)) + (-vs_TEXCOORD0.yx);
    u_xlat6.xy = u_xlat16_6.xy * vec2(vec2(_Amp, _Amp)) + vs_TEXCOORD0.xy;
    u_xlat0.xy = (-u_xlat0.xy) * vec2(200.0, 200.0) + u_xlat1.xy;
    u_xlat0.xy = u_xlat0.xy / vec2(_TexScale);
    u_xlat16_1 = texture(_MainTex, u_xlat0.xy);
    u_xlat1 = u_xlat16_1 * _WaveCol;
    u_xlat0.xy = _Time.xy * vec2(vec2(_Freq, _Freq));
    u_xlat0.xy = sin(u_xlat0.xy);
    u_xlat0.xy = u_xlat0.xy * vec2(200.0, 200.0) + u_xlat6.xy;
    u_xlat0.xy = u_xlat0.xy / vec2(_TexScale);
    u_xlat16_0 = texture(_MainTex, u_xlat0.xy);
    u_xlat0 = u_xlat16_0 * _WaveCol;
    u_xlat0 = u_xlat0 * vec4(vec4(_WaveDecay, _WaveDecay, _WaveDecay, _WaveDecay)) + _MainCol;
    u_xlat0 = u_xlat1 * vec4(vec4(_WaveDecay, _WaveDecay, _WaveDecay, _WaveDecay)) + u_xlat0;
    u_xlat0 = u_xlat0 * vec4(_Fade);
    u_xlat0 = u_xlat0 * vec4(5.0, 5.0, 5.0, 5.0);
