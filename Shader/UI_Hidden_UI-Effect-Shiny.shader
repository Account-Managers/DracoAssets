...
void main()
{
    ...
    u_xlatb5.xy = lessThan(vs_TEXCOORD1.xyxx, _ClipRect.zwzz).xy;
...
void main()
{
    ...
    u_xlat16_0.x = min(abs(u_xlat16_0.x), 1.0);
    u_xlat16_0.x = (-u_xlat16_0.x) + 1.0;
    u_xlat16_4.x = u_xlat16_1.z + u_xlat16_1.z;
    u_xlat16_4.x = float(1.0) / u_xlat16_4.x;
    u_xlat16_0.x = u_xlat16_4.x * u_xlat16_0.x;
...
void main()
{
    ...
    u_xlat16_2.x = u_xlat1.w * u_xlat0 + -0.00100000005;
    u_xlat0 = u_xlat0 * u_xlat1.w;
    u_xlatb4.x = u_xlat16_2.x<0.0;
    ...
    u_xlat16_6.xyz = u_xlat1.xyz * vec3(10.0, 10.0, 10.0) + vec3(-1.0, -1.0, -1.0);
...
;
    ...
    u_xlat16_2.x = min(abs(u_xlat16_2.x), 1.0);
    u_xlat16_2.x = (-u_xlat16_2.x) + 1.0;
    u_xlat16_6.x = u_xlat16_3.z + u_xlat16_3.z;
    u_xlat16_6.x = float(1.0) / u_xlat16_6.x;
    u_xlat16_2.x = u_xlat16_6.x * u_xlat16_2.x;
#ifdef UNITY_ADRENO_ES3
