...
//
///////////////////////////////////////////
Shader "FantaZiumGo/MatCap/Reflective_sphere_vc" {
Properties {
...
void main ()
{
  ...
  xlv_TEXCOORD1 = normalize((unity_MatrixV * (unity_ObjectToWorld * tmpvar_5)).xyz);
  xlv_TEXCOORD2 = normalize(((unity_MatrixV * unity_ObjectToWorld) * tmpvar_6)).xyz;
  xlv_COLOR = tmpvar_3;
}
...
void main ()
{
  ...
  tmpvar_1 = ((tmpvar_10 + _Color) * xlv_COLOR);
