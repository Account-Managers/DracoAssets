...
void main()
{
    ...
    u_xlat0.xyz = u_xlat10_0.xyz * _GradientColor.xyz;
    ...
    u_xlat10_1.xyz = texture2D(_MatCap, u_xlat1.xy).xyz;
    ...
    u_xlat0.xyz = u_xlat0.xyz * vec3(_GradientIn) + u_xlat16_1.xyz;
...
UNITY_LOCATION(2) uniform mediump sampler2D _GradientMap;
...
void main()
{
    ...
    u_xlat0.xyz = u_xlat16_0.xyz * _GradientColor.xyz;
    u_xlat9 = dot(vs_TEXCOORD1.xyz, vs_TEXCOORD2.xyz);
    u_xlat9 = u_xlat9 + u_xlat9;
    u_xlat1.xyz = vs_TEXCOORD2.xyz * (-vec3(u_xlat9)) + vs_TEXCOORD1.xyz;
    u_xlat16_2.x = dot(u_xlat1.xy, u_xlat1.xy);
    u_xlat16_5 = u_xlat1.z + 1.0;
    u_xlat16_2.x = u_xlat16_5 * u_xlat16_5 + u_xlat16_2.x;
    u_xlat16_2.x = sqrt(u_xlat16_2.x);
    u_xlat16_2.x = u_xlat16_2.x + u_xlat16_2.x;
    u_xlat1.xy = u_xlat1.xy / u_xlat16_2.xx;
    u_xlat1.xy = u_xlat1.xy + vec2(0.5, 0.5);
    u_xlat16_1.xyz = texture(_MatCap, u_xlat1.xy).xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * vec3(_MatCapIn);
