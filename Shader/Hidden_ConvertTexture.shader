...
ImmCB_0[1] = vec4(0.0,0.0,1.0,0.0);
ImmCB_0[2] = vec4(1.0,0.0,0.0,0.0);
ImmCB_0[3] = vec4(1.0,0.0,0.0,0.0);
ImmCB_0[4] = vec4(1.0,0.0,0.0,-1.0);
ImmCB_0[5] = vec4(-1.0,0.0,0.0,-1.0);
ImmCB_0[6] = vec4(0.0,0.0,1.0,0.0);
ImmCB_0[7] = vec4(0.0,0.0,-1.0,0.0);
ImmCB_0[8] = vec4(0.0,0.0,0.0,-1.0);
ImmCB_0[9] = vec4(0.0,0.0,0.0,-1.0);
    ...
    u_xlat1.xy = ImmCB_0DynamicIndex(u_xlati4).zx * ImmCB_0DynamicIndex(u_xlati4 + 4).wz;
    u_xlat2.xz = ImmCB_0DynamicIndex(u_xlati4 + 4).zw;
    u_xlat2.y = ImmCB_0DynamicIndex(u_xlati4).z;
    u_xlat0.z = ImmCB_0DynamicIndex(u_xlati4).x;
    u_xlat0.xzw = (-u_xlat2.xyz) * u_xlat0.xxz + u_xlat1.xyz;
    u_xlat1.y = 0.0;
    u_xlat2.xy = in_TEXCOORD0.xy * _MainTex_ST.xy + _MainTex_ST.zw;
    u_xlat2.xy = u_xlat2.xy * vec2(2.0, 2.0) + vec2(-1.0, -1.0);
    u_xlat1.xz = ImmCB_0DynamicIndex(u_xlati4).xz;
    u_xlat3.yz = ImmCB_0DynamicIndex(u_xlati4 + 4).wz;
...
ImmCB_0[9] = vec4(0.0,0.0,0.0,-1.0);
    ...
    u_xlat1.z = 0.0;
    u_xlati4 = int(_faceIndex);
    u_xlat1.xy = ImmCB_0[u_xlati4].zx * ImmCB_0[u_xlati4 + 4].wz;
    u_xlat2.xz = ImmCB_0[u_xlati4 + 4].zw;
    u_xlat2.y = ImmCB_0[u_xlati4].z;
    u_xlat0.z = ImmCB_0[u_xlati4].x;
    u_xlat0.xzw = (-u_xlat2.xyz) * u_xlat0.xxz + u_xlat1.xyz;
    u_xlat1.y = 0.0;
    u_xlat2.xy = in_TEXCOORD0.xy * _MainTex_ST.xy + _MainTex_ST.zw;
    u_xlat2.xy = u_xlat2.xy * vec2(2.0, 2.0) + vec2(-1.0, -1.0);
    u_xlat1.xz = ImmCB_0[u_xlati4].xz;
    u_xlat3.yz = ImmCB_0[u_xlati4 + 4].wz;
    u_xlat0.xyz = u_xlat2.xxx * u_xlat1.xyz + u_xlat0.xzw;
    u_xlat3.x = 0.0;
    vs_TEXCOORD0.xyz = u_xlat2.yyy * u_xlat3.xyz + u_xlat0.xyz;
    return;
