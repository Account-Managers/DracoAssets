...
//
///////////////////////////////////////////
Shader "FantaZiumGo/Particles/Add_ScrollX_edgeFade" {
Properties {
_TintColor ("Tint Color", Color) = (0.5,0.5,0.5,0.5)
_MainTex ("Particle Texture", 2D) = "white" { }
_ScrollSpeed ("Scroll Speed", Range(-100, 100)) = 1
...
void main ()
{
  ...
  uv_1.y = (xlv_TEXCOORD0.y + (_Time * _ScrollSpeed).x);
  lowp vec4 tmpvar_2;
  tmpvar_2 = ((2.0 * xlv_COLOR) * (_TintColor * texture2D (_MainTex, uv_1)));
...
void main ()
{
  ...
  uv_2.y = (xlv_TEXCOORD0.y + (_Time * _ScrollSpeed).x);
  lowp vec4 tmpvar_4;
  tmpvar_4 = ((2.0 * tmpvar_1) * (_TintColor * texture2D (_MainTex, uv_2)));
...
void main ()
{
  ...
  uv_2.y = (xlv_TEXCOORD0.y + (_Time * _ScrollSpeed).x);
  lowp vec4 tmpvar_3;
  tmpvar_3 = ((2.0 * xlv_COLOR) * (_TintColor * texture2D (_MainTex, uv_2)));
  col_1.w = tmpvar_3.w;
...
void main ()
{
  ...
  uv_3.y = (xlv_TEXCOORD0.y + (_Time * _ScrollSpeed).x);
  lowp vec4 tmpvar_5;
  tmpvar_5 = ((2.0 * tmpvar_1) * (_TintColor * texture2D (_MainTex, uv_3)));
  col_2.w = tmpvar_5.w;
