...
void main()
{
    u_xlat10_0.xyz = texture2D(_TeamColMask, vs_TEXCOORD0.xy).xyz;
    u_xlat1.xyz = u_xlat10_0.xyz * _TeamCol.xyz;
...
#endif
uniform 	mediump vec4 _TeamCol;
UNITY_LOCATION(0) uniform mediump sampler2D _TeamColMask;
...
void main()
{
    u_xlat16_0.xyz = texture(_TeamColMask, vs_TEXCOORD0.xy).xyz;
    u_xlat1.xyz = u_xlat16_0.xyz * _TeamCol.xyz;
...
void main()
{
    ...
    u_xlat10_2.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat1.xyz = u_xlat1.xyz * u_xlat10_2.xyz;
    u_xlat16_3.xyz = u_xlat10_2.xyz * u_xlat0.xyz + u_xlat1.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat1.xyz = u_xlat1.xyz * u_xlat16_2.xyz;
    u_xlat16_3.xyz = u_xlat16_2.xyz * u_xlat0.xyz + u_xlat1.xyz;
    u_xlat0.xyz = u_xlat16_3.xyz + (-unity_FogColor.xyz);
    u_xlat12 = vs_TEXCOORD1;
