...
void main()
{
    ...
    u_xlat10_0.xyz = texture2D(_GradientMap, u_xlat1.xz).xyz;
    u_xlat1.xyz = u_xlat10_0.xyz * _GradientColor.xyz;
    u_xlat0.xyz = (-u_xlat10_0.xyz) * vec3(_GradientIn) + vec3(1.0, 1.0, 1.0);
    u_xlat1.xyz = u_xlat1.xyz * vec3(_GradientIn);
    u_xlat1.xyz = u_xlat1.xyz + u_xlat1.xyz;
    u_xlat10_2.xyz = texture2D(_MatCap, vs_TEXCOORD1.xy).xyz;
    u_xlat10_3 = texture2D(_MatCapMask, vs_TEXCOORD0.xy);
...
UNITY_LOCATION(1) uniform mediump sampler2D _MatCapMask;
...
void main()
{
    ...
    u_xlat1.xy = vs_TEXCOORD2.xy * vec2(_TexScaleX, _TexScaleY);
    u_xlat1.z = u_xlat4.x * u_xlat0.x + u_xlat1.y;
    u_xlat16_0.xyz = texture(_GradientMap, u_xlat1.xz).xyz;
    u_xlat1.xyz = u_xlat16_0.xyz * _GradientColor.xyz;
    u_xlat0.xyz = (-u_xlat16_0.xyz) * vec3(_GradientIn) + vec3(1.0, 1.0, 1.0);
    u_xlat1.xyz = u_xlat1.xyz * vec3(_GradientIn);
    u_xlat1.xyz = u_xlat1.xyz + u_xlat1.xyz;
    u_xlat16_2.xyz = texture(_MatCap, vs_TEXCOORD1.xy).xyz;
    u_xlat16_3 = texture(_MatCapMask, vs_TEXCOORD0.xy);
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_3.xyz;
    u_xlat16_2.w = u_xlat16_3.w;
    u_xlat16_2 = u_xlat16_2 * vec4(_MatCapIn);
