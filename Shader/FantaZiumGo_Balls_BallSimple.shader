...
void main()
{
    ...
    u_xlat16_1 = u_xlat16_4 * u_xlat16_4 + u_xlat16_1;
    ...
    u_xlat1 = u_xlat10_1 * _TimeColor;
    u_xlat10_2 = texture2D(_EmisMask, vs_TEXCOORD0.xy);
    u_xlat16_2 = u_xlat10_2 * _EmisCol;
    SV_Target0 = u_xlat1 * u_xlat16_0 + u_xlat16_2;
    return;
}
...
void main()
{
    ...
    u_xlat1 = u_xlat16_1 * _TimeColor;
    u_xlat16_2 = texture(_EmisMask, vs_TEXCOORD0.xy);
    u_xlat16_2 = u_xlat16_2 * _EmisCol;
    SV_Target0 = u_xlat1 * u_xlat16_0 + u_xlat16_2;
    return;
}
